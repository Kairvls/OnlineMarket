    ...
    return (
        <div className="bg-blue-500">
            <main >
                ...
                <Image alt='logo' src='/GCash_logo.svg.png' style={{position: 'absolute', width: '300px', height: '100px', marginLeft: '90px', marginTop: '200px', backgroundColor: 'blue', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', }} />
                <Image alt='logo' src='/PayMaya_Logo.png' style={{position: 'absolute', width: '300px', height: '100px', marginLeft: '440px', marginTop: '200px', backgroundColor: '#1f7a1f', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', }} />
                <Image alt='logo' src='/BDO_Unibank_(logo).svg.png' style={{position: 'absolute', width: '300px', height: '100px', marginLeft: '790px', marginTop: '200px', backgroundColor: '#4d4dff', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', }} />
                <Image alt='logo' src='/Security-Bank-logo-1024x164.png' style={{position: 'absolute', width: '300px', height: '100px', marginLeft: '1140px', marginTop: '200px', backgroundColor: '#1f1f7a', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', }} />
                <Image alt='logo' src='Metrobank_logo_2017_07_21_11_35_10_0.jpg' style={{position: 'absolute', width: '300px', height: '100px', marginLeft: '90px', marginTop: '450px', backgroundColor: '#330066', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', }} />
                <Image alt='logo' src='/2069482.png' style={{position: 'absolute', width: '300px', height: '100px', marginLeft: '440px', marginTop: '450px', backgroundColor: '#800000', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', }} />
                <Image alt='logo' src='/601-6019807_cash-pay-today-cash-pay-logo-hd-png.png' style={{position: 'absolute', width: '300px', height: '100px', marginLeft: '790px', marginTop: '450px', backgroundColor: '#f0f5f5', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', }} />
                <Image alt='logo' src='/visa-logo-visa-icon-transparent-free-png.webp' style={{position: 'absolute', width: '300px', height: '100px', marginLeft: '1140px', marginTop: '450px', backgroundColor: '#e0ebeb', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', }} />
                </section>
