      ...
      <div className="container bg-white rounded-lg shadow-lg p-4 relative">
        ...
        <div className="flex flex-wrap">
          <img
            ...
            src={`/images/meat_item/${item.name.toLowerCase()}.jpg`}
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            {/* Additional Content */}
            <div className="animate-blinkss flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                <span className="mr-3">Adjust</span>
            ...
            <div className="flex">
              ...
              <button className="animate-blinkss flex ml-[19rem] text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-blue-700 rounded">
                Buy
              </button>
              ...
              <p className="text bg-[#19191C] py-2 bg-opacity-50 rounded-lg text-white text-[0.7em] w-[100px] absolute bottom-[2.5rem] ml-6 opacity-0 group-hover:opacity-100 transition-opacity duration-[0.3s] flex items-center justify-center">
                Add to Cart
              </p>
              </button>
