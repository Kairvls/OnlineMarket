...
const SeafoodPage = () => {
    ...
    useEffect(() => {
        ...
        fetch('/api/meat') // Adjust this URL if needed
            .then((res) => res.json()) // Parse the response as JSON
            .then((data) => setMeatItems(data)) // Set seafood items state
    ...
    return (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width={100} height={60} fill="#28A745" className="bi bi-cart-check-fill flex justify-center text-center ml-[-2px] items-center py-3" viewBox="0 0 16 16">
        <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0m7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-1.646-7.646-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L8 8.293l2.646-2.647a.5.5 0 0 1 .708.708"/>
            ...
            <p className="flex justify-center ml-[30rem] items-center 
                 font-medium text-white text-md">MEAT & POULTRY SECTION</p>
        ...
        <section className="snap-start h-[140vh] bg-white text-gray-600 body-font">
                    ...
                    <div className="flex flex-wrap -mt-8">
                        ...
                        <label htmlFor="item">
                            ...
                            <h2 className="text-black title-font text-lg font-medium">{item.name}</h2>
                            
                            <p className="mt-1">₱ {item.price_per_kg} per-kilo</p>
