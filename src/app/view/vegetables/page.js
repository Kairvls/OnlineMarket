...
const SeafoodPage = () => {
    ...
    useEffect(() => {
        ...
        fetch('/api/vegetables') // Adjust this URL if needed
            .then((res) => res.json()) // Parse the response as JSON
            .then((data) => setVegetablesItems(data)) // Set seafood items state
    ...
    return (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width={100} height={60} fill="#28A745" className="bi bi-cart-check-fill flex justify-center text-center ml-[-2px] items-center py-3" viewBox="0 0 16 16">
        ...
        <section className="animate-blinksssssss snap-start h-[110vh] bg-white text-gray-600 body-font">
